...
public class PlaylistManager extends ListPlaylistManager<AudioTrack> implements OnErrorListener {
  ...
  public AudioTrack removeItem(int index, @Nullable String itemId) {
    ...
    // If removingCurrent gets set to true, we are removing the currently playing
    // item,
  ...
  public void changeContinousMode(boolean isContinuous) {
    this.isContinuous = isContinuous;
    Log.i("PlaylistManager", "change isContinuous = " + this.isContinuous);
  }
