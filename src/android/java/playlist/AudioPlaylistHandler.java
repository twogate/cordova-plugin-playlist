...
public class AudioPlaylistHandler<I extends PlaylistItem, M extends BasePlaylistManager<I>>
  ...
  private M playlistManager;

  AudioPlaylistHandler(Context context, Class<? extends Service> serviceClass, M playlistManager,
      ...
      MediaSessionProvider mediaSessionProvider, MediaControlsProvider mediaControlsProvider,
      AudioFocusProvider<I> audioFocusProvider, @Nullable Listener<I> listener) {
    super(context, serviceClass, playlistManager, imageProvider, notificationProvider, mediaSessionProvider,
        mediaControlsProvider, audioFocusProvider, listener);
    // Lmao this entire class exists for the sake of this one line
    // The default value is 30fps (e.g 33ms), which would overwhelm the Cordova
    // webview with messages
  ...
  public boolean onError(MediaPlayerApi<I> mediaPlayer) {
    ...
    // User has no network? The only way to be *certain* is to capture all user
    // interaction
    // input points and create a global flag "somewhere" that says the user has
    // tried to play.
  ...
  public void onSeekComplete(MediaPlayerApi<I> mediaPlayer) {
    ...
    getCurrentMediaProgress().update(mediaPlayer.getCurrentPosition(), mediaPlayer.getBufferedPercent(),
  ...
  public void onCompletion(MediaPlayerApi<I> mediaPlayer) {
    ...
    Log.i("isContinuous", "" + manager.isContinuous);
  ...
  public static class Builder<I extends PlaylistItem, M extends BasePlaylistManager<I>> {
    ...
    public Builder(Context context, Class<? extends Service> serviceClass, M playlistManager,
        ImageProvider<I> imageProvider, Listener<I> listener) {
    ...
    public AudioPlaylistHandler<I, M> build() {
      return new AudioPlaylistHandler<>(context, serviceClass, playlistManager, imageProvider,
          ...
          audioFocusProvider != null ? audioFocusProvider : new DefaultAudioFocusProvider<>(context), listener);
    }
  }
}
